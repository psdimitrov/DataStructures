namespace CustomDataStructuresTests
{
    ...
    {
        private CustomLinkedList<int> list = new CustomLinkedList<int>();

        [TestMethod]
        public void InsertTest()
        {
            this.list = new CustomLinkedList<int>(new[] { 1, 2, 3, 4, 5 });
        ...
        {
            this.list = new CustomLinkedList<int>(new[] { 1, 2, 3, 4, 5, 6 });
        ...
        {
            this.list = new CustomLinkedList<int>(new[] { 10, 20, 30, 40, 50 });
